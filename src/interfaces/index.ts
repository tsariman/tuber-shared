...
export type { default as IStateAnchorOrigin } from './IStateAnchorOrigin';
...
export type * from './IStateIcon';
export type { default as IStateLink } from './IStateLink';
export type * from './IStateLink';
export type { default as IStateNet } from './IStateNet';
export type { default as IStatePage } from './IStatePage';
